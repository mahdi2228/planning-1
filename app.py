...
def _day_color_policy_html(sequence: str) -> str:
    ...
    note = "1 couleur privilégiée · 2 maximum · BLANC ↔ NOIR/DARK interdit"
    return (
...
def render_planning(result: Dict[str, Any], cfg: PlannerConfig) -> None:
    m = result["metrics"]
    hero_msg = "Le moteur choisit automatiquement les commandes, privilégie 1 couleur par jour et utilise une 2e couleur uniquement si elle améliore la couverture, avec un maximum strict de 2 couleurs. Les transitions directes BLANC ↔ NOIR/DARK sont interdites, puis la proposition est réparée et validée avant affichage."
    ...
    with right:
        ...
        st.caption("Politique couleur: 1 couleur privilégiée · 2 maximum · BLANC ↔ NOIR/DARK interdit")
...
def render_ui() -> None:
    ...
    if nav == "🤖 Planning IA":
        ...
        rules = pd.DataFrame([
            ...
            ["Séquence blanc/noir", "Transition directe BLANC <-> NOIR/DARK interdite"],
